...
struct JonesWilkinsLeeBurnModelData {
...
struct MaterialModelData {
  ...
  enum EOS {STIFFENED_GAS = 0, NOBLE_ABEL_STIFFENED_GAS = 1, MIE_GRUNEISEN = 2, 
            ...
            HOMOGENEOUS_INCOMPRESSIBLE = 7, JWLBURN = 8} eos;
  double rhomin;
  double pmin;
  double rhomax;
  double pmax;
  ...
  JonesWilkinsLeeBurnModelData      jwlBurnModel;
...
struct OutputData {
  ...
  Options density, velocity, pressure, materialid, internal_energy, delta_internal_energy, sound_speed,
