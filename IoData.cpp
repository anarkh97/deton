...
JonesWilkinsLeeBurnModelData::JonesWilkinsLeeBurnModelData() 
{
  //default values are for the gaseous products of TNT (Page 21 of Arthur Rallu's thesis)
  omega = 0.28;     //nondimensional
  A1    = 3.712e11; //Pa
  ...
  R2    = 0.95;     //nondimensional
  rho0  = 1.63e-3;  //g/mm3
  edet  = 4.184e+12; // mm^2/s^2
}

//------------------------------------------------------------------------------

void JonesWilkinsLeeBurnModelData::setup(const char *name, ClassAssigner *father)
{

  ClassAssigner *ca = new ClassAssigner(name, 7, father);

  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "Omega", this, 
                                            &JonesWilkinsLeeBurnModelData::omega);
  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "A1", this, 
                                            &JonesWilkinsLeeBurnModelData::A1);
  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "A2", this, 
                                            &JonesWilkinsLeeBurnModelData::A2);
  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "R1", this, 
                                            &JonesWilkinsLeeBurnModelData::R1);
  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "R2", this, 
                                            &JonesWilkinsLeeBurnModelData::R2);
  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "Rho0", this, 
                                            &JonesWilkinsLeeBurnModelData::rho0);
  new ClassDouble<JonesWilkinsLeeBurnModelData>(ca, "EDet", this, 
                                            &JonesWilkinsLeeBurnModelData::edet);
...
Assigner *MaterialModelData::getAssigner()
{
  ...
  new ClassToken<MaterialModelData>(ca, "EquationOfState", this,
                                 reinterpret_cast<int MaterialModelData::*>(&MaterialModelData::eos), 9,
                                 ...
                                 "JonesWilkinsLeeBurn", MaterialModelData::JWLBURN,
  ...
  jwlBurnModel.setup("JonesWilkinsLeeBurnModel", ca);
